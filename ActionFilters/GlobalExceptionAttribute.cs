using RevCode_API.ErrorHelper;
using RevCode_API.Helpers;
using System;
...
namespace RevCode_API.ActionFilters
{
    public class GlobalExceptionAttribute: ExceptionFilterAttribute
    {
        public override void OnException(HttpActionExecutedContext context)
        {
            ...
            {
                throw new HttpResponseException(context.Request.CreateResponse(HttpStatusCode.InternalServerError, new ServiceStatus() { StatusCode = (int)HttpStatusCode.InternalServerError, StatusMessage = "Internal server error", ReasonPhrase = context.Exception.Message }));
            }
        }
    }
}